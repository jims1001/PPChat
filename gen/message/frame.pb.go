...
const (
	MessageFrameData_TYPE_UNSPECIFIED MessageFrameData_Type = 0 // 未指定（默认）
	// ========= 基础业务帧 =========
	MessageFrameData_DATA           MessageFrameData_Type = 1  // 业务消息：payload = MessageData
	MessageFrameData_REGISTER       MessageFrameData_Type = 2  // 上线注册
	MessageFrameData_UNREGISTER     MessageFrameData_Type = 3  // 下线注销
	MessageFrameData_DELIVER        MessageFrameData_Type = 4  // 服务端主动下发
	MessageFrameData_PING           MessageFrameData_Type = 5  // 心跳（客户端->服务端，或服务端保活）
	MessageFrameData_MESSAGE_UPDATE MessageFrameData_Type = 6  // 消息编辑/版本更新
	MessageFrameData_MESSAGE_ACTION MessageFrameData_Type = 7  // 协作动作（表单/投票等）
	MessageFrameData_SYSTEM_EVENT   MessageFrameData_Type = 8  // 系统事件（踢人/转接/禁言等）
	MessageFrameData_AUTH           MessageFrameData_Type = 9  // 鉴权/授权
	MessageFrameData_CONN           MessageFrameData_Type = 10 // 连接信息（连接建立/切换/状态通知）
	// ========= 确认/回执帧 =========
	MessageFrameData_ACK   MessageFrameData_Type = 11 // 服务端 -> 客户端：确认消息（发送成功/送达/已读，ack_type区分）
	MessageFrameData_NACK  MessageFrameData_Type = 12 // 服务端 -> 客户端：否定确认（写库失败/鉴权失败/风控拒绝等）
	MessageFrameData_CACK  MessageFrameData_Type = 18 // 客户端 -> 服务端：确认回执（送达确认、已读上报）
	MessageFrameData_CNACK MessageFrameData_Type = 19 // 客户端 -> 服务端：否定回执（无法渲染、解密失败、本地存储失败等）
	// ========= 同步/重传帧 =========
	MessageFrameData_SYNC           MessageFrameData_Type = 13 // 消息同步：增量/全量拉取、游标对齐
	MessageFrameData_RESEND_REQUEST MessageFrameData_Type = 14 // 重传请求：客户端缺包，指定seq/id补发
	// ========= 性能/安全扩展 =========
	MessageFrameData_BATCH      MessageFrameData_Type = 15 // 批量封装：多帧打包一次传输
	MessageFrameData_KEY_UPDATE MessageFrameData_Type = 16 // 会话密钥/加密元数据更新
	// ========= 状态/存在性 =========
	MessageFrameData_PRESENCE MessageFrameData_Type = 17 // 在线状态/输入状态/活动状态更新
)
...
var file_message_frame_proto_rawDesc = []byte{
	...
	0x61, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x10, 0x0a, 0x10, 0x4d, 0x65, 0x73,
	...
	0x02, 0x38, 0x01, 0x22, 0x98, 0x02, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10,
	...
	,
	...
	0x4e, 0x54, 0x10, 0x03, 0x42, 0x06, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x4a, 0x04, 0x08, 0x64,
	0x10, 0x78, 0x42, 0x1c, 0x5a, 0x1a, 0x50, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x67,
	0x65, 0x6e, 0x2f, 0x6d, 0x73, 0x67, 0x3b, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x70, 0x62,
