...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12R\n" +
	"\bSayHello\x12\x18.example.v1.HelloRequest\x1a\x16.example.v1.HelloReply\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/helloB#Z!PProject/gen/example/v1;v1b\x06proto3"
