...
const (
	GatewayControl_Send_FullMethodName = "/gateway.GatewayControl/Send"
)
...
type GatewayControlClient interface {
	Send(ctx context.Context, in *SendMessageFrame, opts ...grpc.CallOption) (*SendReply, error)
}
...
func (c *gatewayControlClient) Send(ctx context.Context, in *SendMessageFrame, opts ...grpc.CallOption) (*SendReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendReply)
	err := c.cc.Invoke(ctx, GatewayControl_Send_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GatewayControlServer interface {
	Send(context.Context, *SendMessageFrame) (*SendReply, error)
...
func (UnimplementedGatewayControlServer) Send(context.Context, *SendMessageFrame) (*SendReply, error) {
...
func _GatewayControl_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessageFrame)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayControlServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GatewayControl_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayControlServer).Send(ctx, req.(*SendMessageFrame))
	}
...
var GatewayControl_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.GatewayControl",
	HandlerType: (*GatewayControlServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Send",
			Handler:    _GatewayControl_Send_Handler,
		},
	},
